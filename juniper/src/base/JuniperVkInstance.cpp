...
void jun::JuniperVkInstance::createInstance() {
    ...
    if (vkCreateInstance(&createInfo, nullptr, mpInstance.get()) != VK_SUCCESS) {
...
VkResult jun::JuniperVkInstance::createDebugUtilsMessengerEXT(
    ...
    if (func != nullptr) {
        ...
        return func(*mpInstance, pCreateInfo, pAllocator, pDebugMessenger);
    } else {
...
void jun::JuniperVkInstance::destroyDebugUtilsMessengerEXT(
    ...
    PFN_vkDestroyDebugUtilsMessengerEXT func = (PFN_vkDestroyDebugUtilsMessengerEXT) vkGetInstanceProcAddr(*mpInstance, "vkDestroyDebugUtilsMessengerEXT");
    if (func != nullptr) {
        jun::Logger::trace("Successfully loaded function. Destroying debug messenger");
        func(*mpInstance, mDebugMessenger, pAllocator);
    } else {
